...
Sua função é validar identidades, processar credenciais, propagar contexto autenticado entre serviços e apoiar a aplicação consistente de políticas de segurança em toda a plataforma.
